...
//	collection := NewCourseClient(api, collectionAddr)
//	collectionData, err := collection.GetCourseData(ctx)
//	if err != nil {
//		panic(err)
//	}
//
...
//	if err != nil {
//		t.Fatal("GetCertificateAddressByIndex err:", err.Error())
//	}
//
...
//	transferData, err := BuildTransferPayload(newAddr, tlb.MustFromTON("0.01"), nil)
//	if err != nil {
//		t.Fatal("BuildMintPayload err:", err.Error())
//	}
//
...
//	}
//
//	newData, err := GetNFTDataAtBlock(ctx, block)
//	if err != nil {
...
//	}
//
//	if roy.Address.String() != "EQCyMa4xOmcr6H0OWbcYtwOTsf6YUSW3KuGj010WgWBVQhoJ" { // address which get paid for  Wallet.seed = (fiction ... rather)
